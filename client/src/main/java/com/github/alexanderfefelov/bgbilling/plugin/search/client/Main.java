...
public class Main extends BGUTabPanel {
    ...
    protected void jbInit() throws Exception {
        ...
        model = new BGTableModel<SearchResult>("SearchResult") {
            protected void initColumns() {
                ...
                addColumn("Месяц баланса", "contractBalanceChangedAt", true);
    ...
    private SearchResult createRecordFromElement(Element element) {
        ...
        record.setContractBalanceChangedAt(element.getAttribute("contractBalanceChangedAt"));
    ...
    private static final String EMPTY_DATE = "2042-06-04";
